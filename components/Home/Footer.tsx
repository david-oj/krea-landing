...
const Footer = () => {
  return (
    <footer className="md:p-8 p-4 flex max-md:flex-col max-md:gap-4 items-center justify-between bg-[#2F2F2F] text-white">
      ...
      <div className="flex gap-5 text-xl md:text-3xl font-medium items-center">
